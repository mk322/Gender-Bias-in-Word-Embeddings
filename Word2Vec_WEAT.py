...
weapons = ["arrow", "club", "gun", "missile", "spear", "ax", "dagger", 
...
# WEAT 4
euro_4 = ["Brad", "Brendan", "Geoffrey", "Greg", "Brett", "Jay", "Matthew", "Neil",
        "Todd", "Allison", "Anne", "Carrie", "Emily", "Jill", "Laurie", "Kristen", "Meredith", "Sarah"]
    
african_4 = ["Darnell", "Hakim", "Jermaine", "Kareem", "Jamal", "Leroy", "Rasheed", "Tremayne", "Tyrone",
...
# WEAT 5
euro_5 =["Brad", "Brendan", "Geoffrey", "Greg", "Brett", "Jay", "Matthew", "Neil", "Todd", 
        "Allison", "Anne", "Carrie", "Emily", "Jill", "Laurie", "Kristen", "Meredith", "Sarah"]

african_5 = ["Darnell", "Hakim", "Jermaine", "Kareem", "Jamal", "Leroy", "Rasheed", "Tremayne", "Tyrone",
            "Aisha", "Ebony", "Keisha", "Kenya", "Latonya", "Lakisha", "Latoya", "Tamika", "Tanisha"]
...
def cal_p_value(x, results):
    ...
    std = statistics.stdev(results)   # Uses a normal distribution to estimate the density

    # Find the 1-cdf of kde and p value of the normal distribution
    return norm.sf(x, loc=mean, scale=std), 1-norm.cdf(x, loc=mean, scale=std)
...
#print(p_value(instruments, weapons, pleasant, unpleasant))  # WEAT 2
#print(p_value(euro_3, african_3, pleasant_3, unpleasant_3))    # WEAT 3
#print(p_value(euro_4, african_4, pleasant_3, unpleasant_3))    # WEAT 4
#print(p_value(euro_4, african_4, pleasant_5, unpleasant_5))    # WEAT 5

print(effect_size(euro_4, african_4, trans_matrix(pleasant_3, model), trans_matrix(unpleasant_3, model)))   # WEAT 4
print(effect_size(euro_5, african_5, trans_matrix(pleasant_5, model), trans_matrix(unpleasant_5, model)))    # WEAT 5
print(p_value(euro_5, african_5, pleasant_5, unpleasant_5))    # WEAT 5
print(p_value(euro_4, african_4, pleasant_4, unpleasant_4))    # WEAT 4
#print(p_value(euro_5, african_5, pleasant_5, unpleasant_5))    # WEAT 5
